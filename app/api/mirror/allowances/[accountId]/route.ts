/**
 * Token Allowances API Endpoint
 *
 * Fetches token allowances for an account from Validation Cloud Mirror Node.
 * Used to check if tokens have sufficient allowance for swaps.
 */
...
export async function GET(
    ...
    try {
        ...
        const url = `${baseUrlWithKey}/api/v1/accounts/${accountId}/allowances/tokens`
        ...
        console.error('❌ Error in allowances API:', error)
        return NextResponse.json(
