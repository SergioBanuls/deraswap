/**
 * Register the new SaucerSwapV2_EXACT adapter in Exchange
 */
...
async function main() {
  console.log("🔧 Registrando SaucerSwapV2_EXACT en Exchange...\n");
