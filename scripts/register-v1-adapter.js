/**
 * Register SaucerSwapV1 adapter in Exchange contract
 */
...
async function main() {
  console.log("🔧 Registrando SaucerSwapV1 en Exchange...\n");
  ...
  const AGGREGATOR_ID = "SaucerSwapV1";
  ...
  try {
    ...
    console.log("✅ El frontend ya está configurado para usar rutas V1");
